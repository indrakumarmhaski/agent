...
export default class LightningApp extends SfCommand {
    static summary = lightningCommonMessages.getMessage('summary', [BUNDLE_TYPE]);
    static description = lightningCommonMessages.getMessage('description', [BUNDLE_TYPE]);
    static examples = lightningAppMessages.getMessages('examples');
    static aliases = ['force:lightning:app:create'];
