...
export default class VisualforceComponent extends SfCommand {
    static summary = messages.getMessage('summary', [VF_TYPE]);
    static description = messages.getMessage('description', [VF_TYPE]);
    static examples = messages.getMessages('examples.component');
    static aliases = ['force:visualforce:component:create'];
