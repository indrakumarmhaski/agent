...
import { arrayWithDeprecation, Flags, loglevel, orgApiVersionFlagWithDeprecations, Ux, } from '@salesforce/sf-plugins-core';
import { DeployCommand, getCoverageFormattersOptions, reportsFormatters, targetUsernameFlag, } from '../../../deployCommand.js';
import { DeployResultFormatter } from '../../../formatters/deployResultFormatter.js';
import { DeployAsyncResultFormatter, } from '../../../formatters/source/deployAsyncResultFormatter.js';
...
export class Deploy extends DeployCommand {
    ...
    lifecycleEventNames = ['predeploy', 'postdeploy'];
    tracking;
    flags;
    org;
    async run() {
    ...
    formatResult() {
        ...
        const formatter = this.isAsync
            ? new DeployAsyncResultFormatter(new Ux({ jsonEnabled: this.jsonEnabled() }), formatterOptions, this.asyncDeployResult)
