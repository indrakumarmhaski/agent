...
import { MdDeployResultFormatter } from '../../../formatters/mdapi/mdDeployResultFormatter.js';
...
export class Deploy extends DeployCommand {
    ...
    formatResult() {
        ...
        const formatter = this.isAsync
            ? new MdDeployAsyncResultFormatter(new Ux({ jsonEnabled: this.jsonEnabled() }), formatterOptions, this.asyncDeployResult)
