...
const getCurrentApiVersion = async () => {
    const apiFromConfig = ConfigAggregator.getValue('apiVersion').value;
    if (apiFromConfig) {
...
export class ForceCommand extends SfCommand {
    static hidden = true;
    static examples = [];
    // eslint-disable-next-line sf-plugin/no-hardcoded-messages-commands
    static summary = 'Display the ASCII art logo for the Salesforce CLI';
    async run() {
