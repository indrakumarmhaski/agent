...
import { PushResultFormatter } from '../../../formatters/source/pushResultFormatter.js';
...
export default class Push extends DeployCommand {
    ...
    async deploy() {
        ...
        const isSequentialDeploy = getBoolean(await this.project.resolveProjectConfig(), 'pushPackageDirectoriesSequentially', false);
    ...
    resolveSuccess() {
        ...
        const isSuccessLike = (result) => result.response.status === RequestStatus.Succeeded ||
    ...
    formatResult() {
        ...
        const formatter = new PushResultFormatter(new Ux({ jsonEnabled: this.jsonEnabled() }), formatterOptions, this.deployResults, this.deletes);
