...
import { ComponentSetBuilder, RequestStatus, } from '@salesforce/source-deploy-retrieve';
import { ensure } from '@salesforce/ts-types';
import { arrayWithDeprecation, Flags, loglevel, requiredOrgFlagWithDeprecations, Ux, } from '@salesforce/sf-plugins-core';
...
export class Retrieve extends SourceCommand {
    ...
    static hidden = true;
    static summary = messages.getMessage('retrieve.summary');
    static description = messages.getMessage('retrieve.description');
    static examples = messages.getMessages('retrieve.examples');
    static flags = {
        loglevel,
    ...
    formatResult() {
        ...
        if (this.isAsync) {
            ...
            const formatter = new RetrieveResultFormatter(new Ux({ jsonEnabled: this.jsonEnabled() }), formatterOptions, ensure(this.retrieveResult));
            if (!this.jsonEnabled()) {
                formatter.display();
            }
