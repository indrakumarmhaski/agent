...
import { ComponentSet, ComponentSetBuilder, RequestStatus, RegistryAccess, } from '@salesforce/source-deploy-retrieve';
import { arrayWithDeprecation, Flags, loglevel, orgApiVersionFlagWithDeprecations, requiredOrgFlagWithDeprecations, Ux, } from '@salesforce/sf-plugins-core';
...
export class Retrieve extends SourceCommand {
    ...
    static flags = {
        ...
        'api-version': { ...orgApiVersionFlagWithDeprecations, char: 'a' },
        loglevel,
    ...
    lifecycleEventNames = ['preretrieve', 'postretrieve'];
    retrieveResult;
    tracking;
    resolvedTargetDir;
    flags;
