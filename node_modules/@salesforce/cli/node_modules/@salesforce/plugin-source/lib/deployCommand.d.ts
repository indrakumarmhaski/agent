...
export declare abstract class DeployCommand extends SourceCommand {
    ...
    protected resolveOutputDir(coverageFormatters: string[], junit: boolean, resultsDir: string | undefined, deployId: string, noThrow: boolean): string;
}
...
export declare const targetUsernameFlag: import("@oclif/core/lib/interfaces/parser.js").OptionFlag<string, import("@oclif/core/lib/interfaces/parser.js").CustomOptions>;
