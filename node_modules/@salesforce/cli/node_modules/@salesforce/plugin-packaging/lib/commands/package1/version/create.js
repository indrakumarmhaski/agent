...
import { Package1Version, PackageVersionEvents } from '@salesforce/packaging';
Messages.importMessagesDirectoryFromMetaUrl(import.meta.url);
const messages = Messages.loadMessages('@salesforce/plugin-packaging', 'package1_version_create');
export class Package1VersionCreateCommand extends SfCommand {
    static summary = messages.getMessage('summary');
    static description = messages.getMessage('description');
    static examples = messages.getMessages('examples');
    static requiresProject = true;
    static deprecateAliases = true;
    static aliases = ['force:package1:version:create'];
    static flags = {
        loglevel,
    ...
    async run() {
        ...
        const result = await Package1Version.create(flags['target-org'].getConnection(flags['api-version']), {
