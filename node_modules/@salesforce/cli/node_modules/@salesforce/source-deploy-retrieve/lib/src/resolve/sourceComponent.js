...
class SourceComponent {
    ...
    getPackageRelativePath(fsPath, format) {
        return format === 'source'
            ? (0, node_path_1.join)(common_1.DEFAULT_PACKAGE_ROOT_SFDX, this.calculateRelativePath(fsPath))
    ...
    calculateRelativePath(fsPath) {
        ...
        if (folderType) {
            ...
            return (0, node_path_1.join)(directoryName, this.fullName.split('/')[0], (0, node_path_1.basename)(fsPath));
        }
        return (0, node_path_1.join)(directoryName, (0, node_path_1.basename)(fsPath));
    }
    parse(contents) {
