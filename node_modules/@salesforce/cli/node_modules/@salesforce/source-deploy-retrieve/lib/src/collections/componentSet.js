...
class ComponentSet extends lazyCollection_1.LazyCollection {
    ...
    static async fromConnection(input) {
        ...
        const connectionResolver = new resolve_1.ConnectionResolver(usernameOrConnection, options.registry, options.metadataTypes);
    ...
    *[Symbol.iterator]() {
    ...
    async getApiVersion() {
        ...
        if (!version) {
            try {
                version = `${await (0, registry_1.getCurrentApiVersion)()}.0`;
            }
            catch (e) {
                version = '58.0';
